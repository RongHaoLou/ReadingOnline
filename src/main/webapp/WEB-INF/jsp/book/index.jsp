...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="/reading/dingdan" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${bookName}"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${bookPrice}"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="${bookName}" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;" onclick="click()">付 款</button>
...
<script language="javascript">
	...
	function click(){
		$.get(
			"http://localhost:8080/reading/dingdan",
			{
			WIDout_trade_no:document.getElementById("WIDout_trade_no").value,
			WIDtotal_amount:document.getElementById("WIDtotal_amount").value,
			WIDsubject:document.getElementById("WIDsubject").value,
			WIDbody:document.getElementById("WIDbody").value
			},function(data){
				alert(data)
				$("#main").html(data)
			}
